...
function Get-LatestVersion {
    try {
        $latestRelease = Invoke-RestMethod -Uri "https://api.github.com/repos/abhiiinavpc369/cursor-free-vip/releases/latest"
        return @{
...
Write-Host "Created by AbhinavJi`n" -ForegroundColor $Theme.Info
